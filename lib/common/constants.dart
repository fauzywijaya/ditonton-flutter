...
const ADD_MESSAGE = 'Added to Watchlist';
const REMOVE_MESSAGE = 'Removed from Watchlist';
const TV_SHOW_EMPTY_MESSAGE = 'No watchlist tv show yet!';
const MOVIE_EMPTY_MESSAGE = 'No watchlist movie yet!';
